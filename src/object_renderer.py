...
class ObjectRenderer:
    ...
    def _calculate_spatial_dimensions(
        self, obj: "SpriteObject", screen_dist: float
    ) -> tuple[int, int]:
        """
    ...
    def _calculate_position_on_screen(
        self, obj: "SpriteObject", screen_dist: float
    ) -> tuple[int, int]:
        """
        ...
        spatial_width, spatial_height = self._calculate_spatial_dimensions(
            obj, screen_dist
        )
        screen_y = (
    ...
    def _get_subsurface(
        self, obj: "SpriteObject", sprite: pygame.Surface, screen_dist: float
    ) -> pygame.Surface:
        """
    ...
    def draw(self, obj: "SpriteObject"):
        ...
        if self._smaller_than_screen(spatial_width, spatial_height):
            ...
            subsurface = self._get_subsurface(obj, sprite, screen_dist)
        ...
        screen_x, screen_y = self._calculate_position_on_screen(obj, screen_dist)
